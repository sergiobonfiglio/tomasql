...
//go:generate go run github.com/sergiobonfiglio/tomasql/cmd/table-def-gen --schema ../schema.sql --package-dir . --package-name basic

func Run() {

	tomasql.SetDialect(tomasql.DefaultDialect)
